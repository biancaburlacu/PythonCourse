...
import pytest
from quiz import play_game, QUESTIONS_AND_ANSWERS
...
class PlayQuizTest(unittest.TestCase):
    ...
    @patch('quiz.get_input', side_effect=["Guido van Rossum", "bool", "", "199", "=="])
    ...
    @patch('quiz.get_input', side_effect=["Guido ", "ool", "", "199", "=="])
